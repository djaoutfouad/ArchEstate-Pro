/**
 * ArchEstate Pro - JSDOM DOM Emulation Test
 * NOTE: This is a fast in-memory JSDOM unit test suite.
 * For real headless browser testing with genuine Chromium in ar-EG locale, run:
 * `npm run test:browser` (which executes scripts/test-playwright.ts)
 */
