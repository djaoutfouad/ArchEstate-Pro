...
const BASE_CALCULATORS: CalculatorDefinition[] = [
  // 1. BA13 Drywall Ceiling Calculator
  {
    ...
    personaImageUrl: '/images/calculators/ba13-drywall-ceiling-installation.jpg',
    imageAlt: 'Worker installing BA13 drywall plasterboard on ceiling metal framing',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 2. PVC Panel Ceiling Calculator
  {
    ...
    personaImageUrl: '/images/calculators/pvc-panel-ceiling-installation.jpg',
    imageAlt: 'Linear interlocking suspended PVC ceiling panels with perimeter shadowline trim',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 3. 60x60 Acoustic Grid Ceiling Estimator
  {
    ...
    personaImageUrl: '/images/calculators/acoustic-tbar-ceiling.jpg',
    imageAlt: 'Suspended modular acoustic ceiling grid with mineral fiber sound absorption tiles',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 4. Multi-Level & LED Cove Ceiling Estimator
  {
    ...
    personaImageUrl: '/images/calculators/cove-ceiling-lighting.jpg',
    imageAlt: 'Recessed modern architectural ceiling tier with soft indirect LED cove lighting',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 5. Traditional Plaster & Staff Ceiling Estimator
  {
    ...
    personaImageUrl: '/images/calculators/plaster-staff-ceiling-cornice.jpg',
    imageAlt: 'Decorative architectural plaster staff molding and ornamental ceiling cornice',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 6. Room Paint & Primer Calculator
  {
    ...
    personaImageUrl: '/images/calculators/paint-roller-wall.jpg',
    imageAlt: 'Paint roller applying smooth coating to interior wall drywall surface',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 7. Floor & Wall Tile Estimator
  {
    ...
    personaImageUrl: '/images/calculators/tile-bathroom-finish.jpg',
    imageAlt: 'Ceramic tile installation on bathroom wall with uniform grout spacer lines',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 8. Concrete Volume & Slab Calculator
  {
    ...
    personaImageUrl: '/images/calculators/concrete-volume-slab-foundation.jpg',
    imageAlt: 'Pouring and leveling concrete foundation slab with reinforcement formwork',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 9. Brick & Block Wall Calculator
  {
    ...
    personaImageUrl: '/images/calculators/bricks-blocks-masonry-wall.jpg',
    imageAlt: 'Standard red brick masonry wall course showing uniform mortar joints',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 10. Air Conditioner BTU Size Calculator
  {
    ...
    personaImageUrl: '/images/calculators/ac-btu-cooling-hvac-unit.jpg',
    imageAlt: 'HVAC technician installing and calibrating split air conditioning cooling unit',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 11. Mortgage Amortization & PITI Calculator
  {
    ...
    personaImageUrl: '/images/calculators/mortgage-financial-planning.jpg',
    imageAlt: 'Mortgage loan analysis worksheet with interest rate calculations and pen',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 12. Rental Yield, Cap Rate & ROI Estimator
  {
    ...
    personaImageUrl: '/images/calculators/rental-yield-property-investment.jpg',
    imageAlt: 'Modern multi-unit residential apartment building architecture for rental yield',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 13. Home Affordability & Maximum Purchase Calculator
  {
    ...
    personaImageUrl: '/images/calculators/affordability-home-buying-budget.jpg',
    imageAlt: 'House keys on property ownership documentation for home affordability',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 14. Real Estate Closing Costs & Notary Estimator
  {
    ...
    personaImageUrl: '/images/calculators/closing-costs-escrow-settlement.jpg',
    imageAlt: 'Reviewing and signing real estate settlement closing cost documentation',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 15. Wallpaper Roll & Pattern Calculator
  {
    ...
    personaImageUrl: '/images/calculators/wallpaper-roll-interior-hanging.jpg',
    imageAlt: 'Designer decorative wallpaper installation with continuous pattern repeat',
    imageWidth: 640,
    imageHeight: 360,
