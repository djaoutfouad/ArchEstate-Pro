...
const BASE_CALCULATORS: CalculatorDefinition[] = [
  ...
  // 2. PVC Panel Ceiling Calculator
  {
    ...
    imageAlt: 'Linear suspended ceiling panel installation with modern architectural finish',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 8. Concrete Volume & Slab Calculator
  {
    ...
    imageAlt: 'Fresh structural concrete pour for foundation slab with rebar reinforcement',
    imageWidth: 640,
    imageHeight: 360,
