...
const BASE_CALCULATORS: CalculatorDefinition[] = [
  ...
  // 2. PVC Panel Ceiling Calculator
  {
    ...
    imageAlt: 'Linear interlocking ceiling panels installed with perimeter trim on suspended frame',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 4. Multi-Level & LED Cove Ceiling Estimator
  {
    ...
    imageAlt: 'Recessed architectural ceiling tier with soft indirect LED cove lighting',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 5. Traditional Plaster & Staff Ceiling Estimator
  {
    ...
    imageAlt: 'Decorative fibrous plaster staff molding and ornamental ceiling cornice',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 8. Concrete Volume & Slab Calculator
  {
    ...
    imageAlt: 'Structural foundation slab construction with steel rebar grid and concrete formwork',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 9. Brick & Block Wall Calculator
  {
    ...
    imageAlt: 'Standard brick masonry wall course showing uniform mortar joints',
    imageWidth: 640,
    imageHeight: 360,
  ...
  // 10. Air Conditioner BTU Size Calculator
  {
    ...
    imageAlt: 'Wall-mounted split air conditioner cooling unit installed in room interior',
    imageWidth: 640,
    imageHeight: 360,
